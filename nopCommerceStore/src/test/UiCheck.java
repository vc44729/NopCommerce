...
public class UiCheck {
	...
	@Test
	  public void test_info_present() {
		test = report.createTest("Ui_check");
	  String value=driver.findElement(By.xpath("//h2[text()='Welcome to our store']")).getText();
	  Assert.assertEquals(value, "Welcome to our store");
	  }
  @BeforeMethod
  ...
  reporter = new ExtentHtmlReporter(System.getProperty("user.dir")+"/test-output/Report5.html");
